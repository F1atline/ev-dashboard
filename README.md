# EVAL e-Mobility Angular Dashboard App

## Summary

The Angular dashboard connects to the [EVAL e-Mobility NodeJs Server](https://github.com/sap-labs-france/ev-server) to display the charging stations in real time.
